USE [_DBA]
GO
/****** Object:  StoredProcedure [dbo].[sp_HADRAgentJobFailover]    Script Date: 30/11/2016 12:06:48 ******/
SET ANSI_NULLS ON
GO
...
--Enable Specific jobs that need to stay enabled irrespective of Primary Mode
SELECT @SQL =  N'exec msdb..sp_update_job @job_name = ''' + 'DatabaseBackup - SYSTEM_DATABASES - FULL' + ''', @enabled = 1'
print @SQL
EXEC sys.sp_executesql @SQL